...
@section('content')
    <div class="row">
        <div class="col-lg-6 mx-auto">
            <div class="card">
                <div class="card-body">
                    <h2 class="mb-2 py-2 text-center bg-success rounded">نموذج إضافة سائق</h2>
                    @if ($errors->any())
                    ...
                    {{ Form::open(['route' => ['driver.store'], 'method' => 'POST', 'class' => 'card-box', 'enctype' => 'multipart/form-data']) }}
                    {{ Form::token() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control form-control-lg" id="transportation_id"
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control form-control-lg" id="state_id" name="state_id">
                                    ...
                                    @foreach ($states as $state)
                                        <option
                                            value="{{ $state->state_id }}" {{ old('state') == $state->state_id ? 'selected' :''}}>
                                            {{$state->state}}
                                        </option>
                                    @endforeach
                                </select>
