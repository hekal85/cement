...
@section('content')
    <div class="row">
        <div class="col-lg-6 mx-auto">
            <div class="card">
                <div class="card-body">
                    <h2 class="mb-2 py-2 text-center bg-success rounded">نموذج إضافة مصنع أسمنت</h2>
                    @if ($errors->any())
                    ...
                    @endif
                    <form action="{{ route('manufactory.store') }}" method="POST">
                        @csrf

                        <div class="form-row">
                            <div class="col-md-6 mb-6">
                                <label for="name">اسم مصنع الأسمنت</label>
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="name" name="name"
                                               ...
                                               value="{{ old('name') }}" placeholder="اسم مصنع الأسمنت"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-6">
