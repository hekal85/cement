...
@section('content')
    <div class="row">
        <div class="col-lg-6 mx-auto">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title">نموذج إضافة مندوب</h4>
                    @if ($errors->any())
                    ...
                    <form action="{{ route('representative.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="name" name="name" class="form-control {{ $errors->has('name') ? 'error' : '' }}" placeholder="اسم المندوب" value="{{ old('name') }}" />
                            </div>
                        </div>
